...
public class JdbcUtilsTest {
    ...
    void testGetDatasetIdentifierFromJdbcUrl() {
        ...
        assertThat(
                JdbcUtils.getDatasetIdentifierFromJdbcUrl(
                        "jdbc:postgresql://localhost:5432/db", "db.schema.table"))
                .hasFieldOrPropertyWithValue("namespace", "postgres://localhost:5432")
                .hasFieldOrPropertyWithValue("name", "db.schema.table");

        assertThat(
                JdbcUtils.getDatasetIdentifierFromJdbcUrl(
                        "jdbc:postgresql://localhost:5432/a", "schema.table"))
                .hasFieldOrPropertyWithValue("namespace", "postgres://localhost:5432")
                .hasFieldOrPropertyWithValue("name", "a.schema.table");
    }
}