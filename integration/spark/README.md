...
```groovy
implementation 'io.openlineage:openlineage-spark:1.4.1-1-ase-apple'
```
...
spark = (SparkSession.builder.master('local')
         ...
         .config('spark.jars.packages', 'io.openlineage:openlineage-spark:1.4.1-1-ase-apple')
...
file = "/home/jovyan/openlineage/libs/openlineage-spark-1.4.1-1-ase-apple.jar"
